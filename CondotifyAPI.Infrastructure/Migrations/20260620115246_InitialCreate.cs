    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessControlDevices_LicenseId_MACAddress",
                table: "AccessControlDevices",
                columns: new[] { "LicenseId", "MACAddress" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AccessControlDevices_LicenseId_SerialNumber",
                table: "AccessControlDevices",
                columns: new[] { "LicenseId", "SerialNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CFTVDevices_LicenseId_IpAddress_HTTPPort_RTSPPort",
                table: "CFTVDevices",
                columns: new[] { "LicenseId", "IpAddress", "HTTPPort", "RTSPPort" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enterprise_CNPJ",
                table: "Enterprise",
                column: "CNPJ",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Enterprise_Email",
                table: "Enterprise",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Licenses_EnterpriseId_Name",
                table: "Licenses",
