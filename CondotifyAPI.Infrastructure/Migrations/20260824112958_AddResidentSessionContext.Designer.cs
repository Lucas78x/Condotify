...
namespace CondotifyAPI.Infrastructure.Migrations
{
    ...
    [Migration("20260824112958_AddResidentSessionContext")]
    partial class AddResidentSessionContext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CondotifyAPI.Domain.DTO.AccessControl.AccessEventRecordDTO", b =>
                {
                    ...
                    b.Property<string>("AttentionResolutionNote")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<DateTime?>("AttentionResolvedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("AttentionResolvedBy")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");
                    ...
                    b.HasIndex("LicenseId", "Authorized", "AttentionResolvedAt");
            ...
            modelBuilder.Entity("CondotifyAPI.Domain.DTO.Announcements.AnnouncementDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CondotifyAPI.Domain.DTO.Governance.AssemblyAgendaItemDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("AbstentionCountsForQuorum")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("AssemblyId", "Order")
                        .IsUnique();

                    b.ToTable("AssemblyAgendaItems", (string)null);
                });

            modelBuilder.Entity("CondotifyAPI.Domain.DTO.Governance.AssemblyAttendanceDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AssemblyAttendances", (string)null);
                });

            modelBuilder.Entity("CondotifyAPI.Domain.DTO.Governance.AssemblyAuditDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AssemblyId", "CreatedAt");

                    b.ToTable("AssemblyAudits", (string)null);
                });

            modelBuilder.Entity("CondotifyAPI.Domain.DTO.Governance.AssemblyEligibleUnitDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AssemblyEligibleUnits", (string)null);
                });

            modelBuilder.Entity("CondotifyAPI.Domain.DTO.Governance.AssemblyVoteDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AgendaItemId", "UnitId")
                        .IsUnique();

                    b.HasIndex("AssemblyId", "CastAt");

                    b.ToTable("AssemblyVotes", (string)null);
                });

            modelBuilder.Entity("CondotifyAPI.Domain.DTO.Governance.AssemblyVoteOptionDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AssemblyVoteOptions", (string)null);
                });

            modelBuilder.Entity("CondotifyAPI.Domain.DTO.Governance.CondominiumAssemblyDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("RequireResponsibleResident")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("LicenseId", "Status", "StartsAt");

                    b.ToTable("CondominiumAssemblies", (string)null);
                });
            ...
            modelBuilder.Entity("CondotifyAPI.Domain.DTO.Users.RefreshTokenDTO", b =>
                {
                    ...
                    b.Property<Guid?>("ContextLicenseId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CondotifyAPI.Domain.DTO.Governance.AssemblyAgendaItemDTO", b =>
                {
                    b.HasOne("CondotifyAPI.Domain.DTO.Governance.CondominiumAssemblyDTO", "Assembly")
            ...
            modelBuilder.Entity("CondotifyAPI.Domain.DTO.Governance.AssemblyVoteDTO", b =>
                {
                    b.HasOne("CondotifyAPI.Domain.DTO.Governance.AssemblyAgendaItemDTO", "AgendaItem")
                        .WithMany("Votes")
                    ...
                    b.HasOne("CondotifyAPI.Domain.DTO.Governance.AssemblyVoteOptionDTO", "Option")
                        .WithMany()
