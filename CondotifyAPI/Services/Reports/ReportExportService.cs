...
public static class ReportExportService
{
    ...
    public static byte[] CreateCsv(LicenseReportsViewModel report, string licenseName, string licenseCode)
    {
        ...
        CsvRow(csv, "Condotify - Relatório do condomínio");
